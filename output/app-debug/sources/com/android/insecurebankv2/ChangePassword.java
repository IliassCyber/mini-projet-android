...
public class ChangePassword extends Activity {
    ...
    class RequestChangePasswordTask extends AsyncTask<String, String, String> {
        ...
        public void postData(String valueIWantToSend) throws JSONException, BadPaddingException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, IOException, InvalidKeyException, InvalidAlgorithmParameterException {
            ...
            changePassword.matcher = changePassword.pattern.matcher(ChangePassword.this.changePassword_text.getText().toString());
            ...
            if (isStrong) {
                ...
                changePassword2.result = changePassword2.result.replace("\n", "");
