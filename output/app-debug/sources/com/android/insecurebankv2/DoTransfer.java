...
public class DoTransfer extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.transfer.setOnClickListener(new View.OnClickListener() { // from class: com.android.insecurebankv2.DoTransfer.1
            ...
            public void onClick(View v) {
                ...
                doTransfer.from = (EditText) doTransfer.findViewById(R.id.editText_from);
                DoTransfer doTransfer2 = DoTransfer.this;
                doTransfer2.to = (EditText) doTransfer2.findViewById(R.id.editText_to);
    ...
    public class RequestDoTransferTask extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... params) {
            ...
            DoTransfer doTransfer2 = DoTransfer.this;
            doTransfer2.to = (EditText) doTransfer2.findViewById(R.id.editText_to);
            DoTransfer doTransfer3 = DoTransfer.this;
            doTransfer3.amount = (EditText) doTransfer3.findViewById(R.id.editText_amount);
            ...
            DoTransfer doTransfer4 = DoTransfer.this;
            doTransfer4.result = doTransfer4.result.replace("\n", "");
                    ...
                    if (DoTransfer.this.result != null) {
                        if (DoTransfer.this.result.indexOf("Success") != -1) {
                            ...
                            try {
                                ...
                                sb.append(DoTransfer.this.from.getText().toString());
                                sb.append(" To:");
                                sb.append(DoTransfer.this.to.getText().toString());
                                sb.append(" Amount:");
                                sb.append(DoTransfer.this.amount.getText().toString());
                                sb.append("\n");
                                String status = new String(sb.toString());
                                try {
                        ...
                        sb2.append("/Statements_");
                        sb2.append(DoTransfer.this.usernameBase64ByteString);
                        sb2.append(".html");
                        String MYFILE2 = sb2.toString();
                        try {
    ...
    public class RequestDoGets2 extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... params) {
            ...
            DoTransfer doTransfer = DoTransfer.this;
            doTransfer.result = doTransfer.result.replace("\n", "");
