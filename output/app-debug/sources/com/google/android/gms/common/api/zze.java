...
public class zze implements zzh {
    ...
    private void zzT(boolean z) {
        zzps zzpsVar = this.zzWT;
        if (zzpsVar != null) {
            if (zzpsVar.isConnected()) {
                if (z) {
                    this.zzWT.zzxY();
                }
    ...
    public boolean zzmC() {
        ...
        ConnectionResult connectionResult = this.zzWM;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void zzmG() {
        Set<Scope> setZzmJ = this.zzWK.zzXw;
        if (setZzmJ.isEmpty()) {
            setZzmJ = zzmJ();
        }
        this.zzWO = 3;
    ...
    private void zzmH() {
        ...
        if (zzpsVar != null) {
            if (this.zzWY) {
                zzpsVar.zza(this.zzWX, this.zzWZ);
            }
            zzT(false);
        }
    ...
    public void begin() {
        ...
        if (this.zzWV) {
            ...
            zzd zzdVar = new zzd();
            Api.zza<? extends zzps, zzpt> zzaVar = this.zzWE;
            Context context = this.mContext;
            Looper looper = this.zzWK.getLooper();
            com.google.android.gms.common.internal.zze zzeVar = this.zzXa;
            this.zzWT = (zzps) zzaVar.zza(context, looper, zzeVar, zzeVar.zznB(), zzdVar, zzdVar);
            this.zzWT.connect();
        }
        this.zzWQ = this.zzWK.zzXu.size();
