...
public final class GooglePlayServicesUtil {
    ...
    public static PendingIntent getErrorPendingIntent(int i, Context context, int i2) {
        ...
        return PendingIntent.getActivity(context, i2, intentZzaT, DriveFile.MODE_READ_ONLY);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x0087, code lost:
        ...
        if (r5.zza(r3, com.google.android.gms.common.zzc.zzbk.zzVR) == null) goto L33;
     */
    ...
    private static void zza(int i, Context context, String str) {
        ...
        if (zzkz.zzai(context)) {
            ...
            if (zzlk.zzoR()) {
                ...
                notification2.setLatestEventInfo(context, strZzi, strZzc, errorPendingIntent);
