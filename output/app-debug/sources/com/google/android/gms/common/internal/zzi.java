...
public abstract class zzi<T extends IInterface> implements Api.Client, zzj.zza {
    ...
    protected class zzf implements GoogleApiClient.ConnectionProgressReportCallbacks {
        ...
        public void onReportServiceBinding(ConnectionResult connectionResult) {
            if (connectionResult.isSuccess()) {
                zzi zziVar = zzi.this;
                zziVar.getRemoteService(null, zziVar.zzWJ);
    ...
    protected final class zzg extends zzi<T>.zza {
        ...
        protected boolean zznO() {
            try {
                ...
                if (iInterfaceZzT == null || !zzi.this.zza(2, 3, iInterfaceZzT)) {
                    return false;
                }
    ...
    /* JADX INFO: renamed from: com.google.android.gms.common.internal.zzi$zzi, reason: collision with other inner class name */
    ...
    private void zznH() {
        ...
        handler.sendMessage(handler.obtainMessage(3, this.zzaau.get(), 9));
    }
    ...
    public void getRemoteService(IAccountAccessor iAccountAccessor, Set<Scope> set) {
        try {
            ...
            if (set != null) {
                getServiceRequestZzf.zzb(set);
            }
            if (requiresSignIn()) {
                getServiceRequestZzf.zzb(zznt()).zzb(iAccountAccessor);
    ...
    public void validateAccount(IAccountAccessor iAccountAccessor) {
        Bundle bundleZznN = zznN();
        Set<Scope> set = this.zzWJ;
        try {
            this.zzaal.zza(new zzd(this, this.zzaau.get()), new ValidateAccountRequest(iAccountAccessor, (Scope[]) set.toArray(new Scope[set.size()]), this.mContext.getPackageName(), bundleZznN));
        } catch (DeadObjectException e) {
            Log.w("GmsClient", "service died");
            zzbs(1);
        } catch (RemoteException e2) {
    ...
    protected void zza(int i, Bundle bundle, int i2) {
        Handler handler = this.mHandler;
        handler.sendMessage(handler.obtainMessage(5, i2, -1, new C0037zzi(i, bundle)));
    }
    ...
    public final void zza(zzi<T>.zzc<?> zzcVar) {
        ...
        Handler handler = this.mHandler;
        handler.sendMessage(handler.obtainMessage(2, this.zzaau.get(), -1, zzcVar));
    }

    public void zzbs(int i) {
        Handler handler = this.mHandler;
        handler.sendMessage(handler.obtainMessage(4, this.zzaau.get(), i));
    }
    ...
    public void zznJ() {
        ...
        this.zzaam = new zzf();
        Handler handler = this.mHandler;
        handler.sendMessage(handler.obtainMessage(3, this.zzaau.get(), iIsGooglePlayServicesAvailable));
    }
