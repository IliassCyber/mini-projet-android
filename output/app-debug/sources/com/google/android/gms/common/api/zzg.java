...
final class zzg implements GoogleApiClient {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean zza(com.google.android.gms.common.api.Scope r2) {
        /*
            r1 = this;
            java.util.concurrent.locks.Lock r0 = r1.zzWL
            r0.lock()
            boolean r0 = r1.isConnected()     // Catch: java.lang.Throwable -> L1c
            if (r0 == 0) goto L15
            java.util.Set<com.google.android.gms.common.api.Scope> r0 = r1.zzXw     // Catch: java.lang.Throwable -> L1c
            boolean r2 = r0.contains(r2)     // Catch: java.lang.Throwable -> L1c
            if (r2 == 0) goto L15
            r2 = 1
            goto L16
        L15:
    ...
    void zzmQ() {
        ...
        zza zzaVar = this.zzXs;
        zzaVar.sendMessageDelayed(zzaVar.obtainMessage(1), this.zzXq);
        zza zzaVar2 = this.zzXs;
        zzaVar2.sendMessageDelayed(zzaVar2.obtainMessage(2), this.zzXr);
    }
