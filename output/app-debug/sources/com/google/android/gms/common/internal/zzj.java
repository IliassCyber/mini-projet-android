...
public final class zzj implements Handler.Callback {
    ...
    public boolean isConnectionCallbacksRegistered(GoogleApiClient.ConnectionCallbacks connectionCallbacks) {
        ...
        synchronized (this.zzqt) {
            zContains = this.zzaaD.contains(connectionCallbacks);
        }
        return zContains;
    }
    ...
    public boolean isConnectionFailedListenerRegistered(GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        synchronized (this.zzqt) {
            zContains = this.zzaaF.contains(onConnectionFailedListener);
        }
        return zContains;
    }
    ...
    public void zzbu(int i) {
        ...
        synchronized (this.zzqt) {
            this.zzaaI = true;
            ArrayList<GoogleApiClient.ConnectionCallbacks> arrayList = new ArrayList(this.zzaaD);
    ...
    public void zzh(ConnectionResult connectionResult) {
        this.mHandler.removeMessages(1);
        synchronized (this.zzqt) {
            ArrayList<GoogleApiClient.OnConnectionFailedListener> arrayList = new ArrayList(this.zzaaF);
            int i = this.zzaaH.get();
