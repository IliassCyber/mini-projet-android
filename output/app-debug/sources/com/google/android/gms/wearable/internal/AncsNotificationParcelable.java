...
public class AncsNotificationParcelable implements SafeParcelable, com.google.android.gms.wearable.zzb {
    ...
    public boolean equals(Object obj) {
        ...
        String str = this.zzaTu;
        if (str == null ? ancsNotificationParcelable.zzaTu == null : str.equals(ancsNotificationParcelable.zzaTu)) {
    ...
    public String getDisplayName() {
        ...
        return str == null ? this.zzaEw : str;
    }
    ...
    public int hashCode() {
        int iHashCode = ((((this.zzCY * 31) + this.mId) * 31) + this.zzaEw.hashCode()) * 31;
        String str = this.zzaTu;
        return ((((((((((((((((iHashCode + (str != null ? str.hashCode() : 0)) * 31) + this.zzRx.hashCode()) * 31) + this.zzadv.hashCode()) * 31) + this.zzaox.hashCode()) * 31) + this.zzadI.hashCode()) * 31) + this.zzaTv) * 31) + this.zzaTw) * 31) + this.zzaTx) * 31) + this.zzaTy;
    }
