...
public class UsageInfo implements SafeParcelable {
    ...
    private static DocumentSection zzh(List<AppIndexApi.AppIndexingLink> list) {
        ...
        for (int i = 0; i < c0140zzaArr.length; i++) {
            c0140zzaArr[i] = new zznj.zza.C0140zza();
            AppIndexApi.AppIndexingLink appIndexingLink = list.get(i);
            c0140zzaArr[i].zzawm = appIndexingLink.appIndexingUrl.toString();
            c0140zzaArr[i].viewId = appIndexingLink.viewId;
            if (appIndexingLink.webUrl != null) {
                c0140zzaArr[i].zzawn = appIndexingLink.webUrl.toString();
            }
        }
