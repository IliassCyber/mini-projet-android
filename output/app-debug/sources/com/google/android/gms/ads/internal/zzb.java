...
public abstract class zzb extends zza implements com.google.android.gms.ads.internal.overlay.zzf, com.google.android.gms.ads.internal.purchase.zzj, zzdi, zzdz {
    ...
    private AdRequestInfoParcel.zza zza(AdRequestParcel adRequestParcel, Bundle bundle) throws PackageManager.NameNotFoundException {
        ...
        if (this.zzon.zzpK == null || this.zzon.zzpK.getParent() == null) {
            ...
            int i3 = (!this.zzon.zzpK.isShown() || i + width <= 0 || i2 + height <= 0 || i > displayMetrics.widthPixels || i2 > displayMetrics.heightPixels) ? 0 : 1;
    ...
    protected boolean zza(zzha zzhaVar, zzha zzhaVar2) {
        ...
        if (zzhaVar2.zzFm != null) {
            i2 = zzhaVar2.zzFm.zzxM;
            i = zzhaVar2.zzFm.zzxN;
        } else {
            i = 0;
        }
        this.zzon.zzqf.zzf(i2, i);
        return true;
    }
    ...
    @Override // com.google.android.gms.ads.internal.zza
    public boolean zzb(AdRequestParcel adRequestParcel) throws PackageManager.NameNotFoundException {
        if (!zzaU()) {
            return false;
        }
