...
public class zzi extends SurfaceView implements AudioManager.OnAudioFocusChangeListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, SurfaceHolder.Callback {
    ...
    private void zzb(float f) {
        MediaPlayer mediaPlayer = this.zzzY;
        if (mediaPlayer == null) {
    ...
    private boolean zzeT() {
        int i;
        return (this.zzzY == null || (i = this.zzzV) == -1 || i == 0 || i == 1) ? false : true;
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int size2;
        int i3;
        int defaultSize = getDefaultSize(this.zzAa, i);
        int defaultSize2 = getDefaultSize(this.zzAb, i2);
        if (this.zzAa > 0 && this.zzAb > 0) {
            ...
            if (mode == 1073741824 && mode2 == 1073741824) {
                ...
                } else if (i4 * size > size2 * i6) {
                    i3 = (i6 * size2) / i4;
                    size = i3;
                }
            } else if (mode == 1073741824) {
                i3 = (this.zzAb * size2) / this.zzAa;
                if (mode2 != Integer.MIN_VALUE || i3 <= size) {
                    size = i3;
                }
            } else if (mode2 == 1073741824) {
                int i7 = (this.zzAa * size) / this.zzAb;
                if (mode != Integer.MIN_VALUE || i7 <= size2) {
                    size2 = i7;
                }
            } else {
                int i8 = this.zzAa;
                ...
                if (mode != Integer.MIN_VALUE || i8 <= size2) {
                    size2 = i8;
                } else {
                    i3 = (this.zzAb * size2) / this.zzAa;
                    size = i3;
    ...
    */
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        ...
        MediaPlayer mediaPlayer = this.zzzY;
        if (mediaPlayer != null && this.zzAi == 0) {
            this.zzAi = mediaPlayer.getCurrentPosition();
        }
        this.zzzX = null;
