...
public class zzz implements zzy {
    ...
    private HttpURLConnection zza(URL url, zzk<?> zzkVar) throws IOException {
        ...
        if ("https".equals(url.getProtocol()) && (sSLSocketFactory = this.zzaG) != null) {
            ((HttpsURLConnection) httpURLConnectionZza).setSSLSocketFactory(sSLSocketFactory);
        }
    ...
    public HttpResponse zza(zzk<?> zzkVar, Map<String, String> map) throws com.google.android.gms.internal.zza, IOException {
        ...
        map2.putAll(map);
        zza zzaVar = this.zzaF;
        if (zzaVar != null) {
            strZzh = zzaVar.zzh(url);
            if (strZzh == null) {
