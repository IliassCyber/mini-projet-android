...
public class zzii extends WebChromeClient {
    ...
    /* JADX INFO: renamed from: com.google.android.gms.internal.zzii$7, reason: invalid class name */
    ...
    private final Context zzc(WebView webView) {
        ...
        return activityZzgB != null ? activityZzgB : zzidVar.getContext();
    }
    ...
    public final void onExceededDatabaseQuota(String str, String str2, long j, long j2, long j3, WebStorage.QuotaUpdater quotaUpdater) {
        ...
        if (j != 0) {
            jMin = j2 == 0 ? Math.min(Math.min(131072L, j4) + j, 1048576L) : j2 <= Math.min(1048576 - j, j4) ? j + j2 : j;
        } else if (j2 <= j4 && j2 <= 1048576) {
            jMin = j2;
        }
        quotaUpdater.updateQuota(jMin);
    }
