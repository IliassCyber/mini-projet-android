...
public class zzfy implements Callable<zzha> {
    ...
    private zzha zza(zzg.zza zzaVar) {
        ...
        synchronized (this.zzqt) {
            i = (zzaVar == null && this.zzBv == -2) ? 0 : this.zzBv;
        }
    ...
    private zzbb zzfq() throws ExecutionException, InterruptedException, CancellationException, TimeoutException {
        ...
        String str = zzbz.zzur.get();
        zzbb zzbbVar = this.zzBI.zza(this.mContext, this.zzBs.zzFr.zzpJ, (this.zzBs.zzFs.zzzG.indexOf("https") == 0 ? "https:" : "http:") + str).get(zzBF, TimeUnit.MILLISECONDS);
        com.google.android.gms.ads.internal.zzm zzmVar = this.zzBH;
        zzbbVar.zza(zzmVar, zzmVar, zzmVar, zzmVar, false, null, null, null, null);
        return zzbbVar;
    }
        ...
        return zzhu.zza(zza(jSONObjectOptJSONObject, "image", false, false), new zzhu.zza<com.google.android.gms.ads.internal.formats.zzc, com.google.android.gms.ads.internal.formats.zza>() { // from class: com.google.android.gms.internal.zzfy.4
            ...
            public com.google.android.gms.ads.internal.formats.zza zze(com.google.android.gms.ads.internal.formats.zzc zzcVar) {
                ...
                try {
                    ...
                    return new com.google.android.gms.ads.internal.formats.zza(strOptString, (Drawable) com.google.android.gms.dynamic.zze.zzn(zzcVar.zzdw()), numZzb2, numZzb, iOptInt > 0 ? Integer.valueOf(iOptInt) : null);
                } catch (RemoteException e) {
    ...
    */
    public com.google.android.gms.internal.zzha call() {
        /*
            r3 = this;
            com.google.android.gms.internal.zzbb r0 = r3.zzfq()     // Catch: java.util.concurrent.TimeoutException -> L18 org.json.JSONException -> L1c java.lang.InterruptedException -> L23 java.util.concurrent.ExecutionException -> L25 java.util.concurrent.CancellationException -> L27
            org.json.JSONObject r1 = r3.zzb(r0)     // Catch: java.util.concurrent.TimeoutException -> L18 org.json.JSONException -> L1c java.lang.InterruptedException -> L23 java.util.concurrent.ExecutionException -> L25 java.util.concurrent.CancellationException -> L27
            com.google.android.gms.internal.zzfy$zza r2 = r3.zzd(r1)     // Catch: java.util.concurrent.TimeoutException -> L18 org.json.JSONException -> L1c java.lang.InterruptedException -> L23 java.util.concurrent.ExecutionException -> L25 java.util.concurrent.CancellationException -> L27
            com.google.android.gms.ads.internal.formats.zzg$zza r1 = r3.zza(r0, r2, r1)     // Catch: java.util.concurrent.TimeoutException -> L18 org.json.JSONException -> L1c java.lang.InterruptedException -> L23 java.util.concurrent.ExecutionException -> L25 java.util.concurrent.CancellationException -> L27
            r3.zza(r1, r0)     // Catch: java.util.concurrent.TimeoutException -> L18 org.json.JSONException -> L1c java.lang.InterruptedException -> L23 java.util.concurrent.ExecutionException -> L25 java.util.concurrent.CancellationException -> L27
            com.google.android.gms.internal.zzha r0 = r3.zza(r1)     // Catch: java.util.concurrent.TimeoutException -> L18 org.json.JSONException -> L1c java.lang.InterruptedException -> L23 java.util.concurrent.ExecutionException -> L25 java.util.concurrent.CancellationException -> L27
            return r0
        L18:
            r0 = move-exception
