...
public class zzs {
    ...
    static class zza {
        ...
        private long zzx() {
            ...
            return this.zzal.get(r2.size() - 1).time - this.zzal.get(0).time;
        }
        ...
        public synchronized void zzd(String str) {
            ...
            for (C0165zza c0165zza : this.zzal) {
                long j2 = c0165zza.time;
                zzs.zzb("(+%-4d) [%2d] %s", Long.valueOf(j2 - j), Long.valueOf(c0165zza.zzan), c0165zza.name);
                j = j2;
            }
        }
    }
