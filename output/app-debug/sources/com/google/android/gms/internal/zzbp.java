...
public class zzbp {
    ...
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zza> priorityQueue) {
        ...
        for (int i3 = 1; i3 < (strArr.length - i2) + 1; i3++) {
            jZza2 = zza(zzbn.zzB(strArr[i3 - 1]), zzbn.zzB(strArr[(i3 + i2) - 1]), jZza2, jZza, 16785407L);
            zza(i, jZza2, zza(strArr, i3, i2), priorityQueue);
        }
    }

    private static long zzb(String[] strArr, int i, int i2) {
        long jZzB = (((long) zzbn.zzB(strArr[i])) + 2147483647L) % 1073807359;
        for (int i3 = i + 1; i3 < i + i2; i3++) {
            jZzB = (((jZzB * 16785407) % 1073807359) + ((((long) zzbn.zzB(strArr[i3])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return jZzB;
    }
}
