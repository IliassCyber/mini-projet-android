    ...
    private static zzag.zza zza(int i, zzaf.zzf zzfVar, zzag.zza[] zzaVarArr, Set<Integer> set) throws zzg {
        ...
        switch (zzaVar.type) {
            ...
            case 2:
                ...
                zzag.zza zzaVarZzo2 = zzo(zzaVar);
                zzaVarZzo2.zziS = new zzag.zza[zzhVarZzp.zziD.length];
                int[] iArr = zzhVarZzp.zziD;
                int length = iArr.length;
                int i3 = 0;
                while (i2 < length) {
                    int i4 = i3 + 1;
                    zzaVarZzo2.zziS[i3] = zza(iArr[i2], zzfVar, zzaVarArr, set);
                    i2++;
                    i3 = i4;
                }
                zzaVarZzo = zzaVarZzo2;
                break;
            case 3:
                ...
                int i6 = 0;
                while (i5 < length2) {
                    zzaVarZzo.zziT[i6] = zza(iArr2[i5], zzfVar, zzaVarArr, set);
                    i5++;
                    i6++;
                }
                ...
                int i7 = 0;
                while (i2 < length3) {
                    zzaVarZzo.zziU[i7] = zza(iArr3[i2], zzfVar, zzaVarArr, set);
                    i2++;
                    i7++;
                }
                break;
            ...
            case 7:
                ...
                int i8 = 0;
                while (i2 < length4) {
                    zzaVarZzo.zziZ[i8] = zza(iArr4[i2], zzfVar, zzaVarArr, set);
                    i2++;
                    i8++;
                }
                break;
