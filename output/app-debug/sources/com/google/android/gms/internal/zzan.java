...
public class zzan {
    ...
    private Uri zzb(Uri uri, String str, String str2) {
        ...
        if (iIndexOf != -1) {
            int i = iIndexOf + 1;
            str3 = string.substring(0, i) + str + "=" + str2 + ";" + string.substring(i);
        } else {
            String encodedPath = uri.getEncodedPath();
            int iIndexOf2 = string.indexOf(encodedPath);
            str3 = string.substring(0, encodedPath.length() + iIndexOf2) + ";" + str + "=" + str2 + ";" + string.substring(iIndexOf2 + encodedPath.length());
        }
