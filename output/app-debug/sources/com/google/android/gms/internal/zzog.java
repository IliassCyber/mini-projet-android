...
public final class zzog implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        zzodVarZza.setScreenName(bundle2.getString("name"));
        zzodVarZza.zzhL(bundle2.getInt("referrer_id"));
        zzodVarZza.zzdJ(bundle2.getString("referrer_name"));
        zzodVarZza.zzai(bundle2.getBoolean("interstitial"));
        zzodVarZza.zzwF();
    }
