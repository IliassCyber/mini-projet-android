...
public final class PlaceImpl implements SafeParcelable, Place {
    ...
    public static class zza {
        ...
        public PlaceImpl zzuX() {
            ...
            List<Integer> list = this.zzaAJ;
            List listEmptyList = Collections.emptyList();
            Bundle bundle = this.zzaAI;
            String str2 = this.mName;
            String str3 = this.zzajO;
            String str4 = this.zzazp;
            String str5 = this.zzaAC;
            List<String> list2 = this.zzaAD;
            return new PlaceImpl(i, str, list, listEmptyList, bundle, str2, str3, str4, str5, list2, this.zzazn, this.zzaAu, this.zzaAv, this.zzaAw, this.zzazq, this.zzaAx, this.zzaAy, this.zzaAz, this.zzaAA, this.zzaAE, PlaceLocalization.zza(str2, str3, str4, str5, list2));
        }
    }
    ...
    private void zzdp(String str) {
        zzo zzoVar;
        if (!this.zzaAE || (zzoVar = this.zzaAH) == null) {
            return;
        }
        zzoVar.zzA(this.zzKI, str);
    }
    ...
    @Override // com.google.android.gms.common.data.Freezable
    /* JADX INFO: renamed from: zzuW, reason: merged with bridge method [inline-methods] */
    public Place freeze() {
        return this;
    }
}
