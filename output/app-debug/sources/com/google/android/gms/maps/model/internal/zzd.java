        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    com.google.android.gms.dynamic.zzd zzdVarZzhD = zzhD(parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zzdVarZzhD != null ? zzdVarZzhD.asBinder() : null);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    com.google.android.gms.dynamic.zzd zzdVarZzdu = zzdu(parcel.readString());
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zzdVarZzdu != null ? zzdVarZzdu.asBinder() : null);
                    return true;
                case 3:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    com.google.android.gms.dynamic.zzd zzdVarZzdv = zzdv(parcel.readString());
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zzdVarZzdv != null ? zzdVarZzdv.asBinder() : null);
                    return true;
                case 4:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    com.google.android.gms.dynamic.zzd zzdVarZzvN = zzvN();
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zzdVarZzvN != null ? zzdVarZzvN.asBinder() : null);
                    return true;
                case 5:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                ...
                case 6:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    com.google.android.gms.dynamic.zzd zzdVarZzb = zzb(parcel.readInt() != 0 ? (Bitmap) Bitmap.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zzdVarZzb != null ? zzdVarZzb.asBinder() : null);
                    return true;
                case 7:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    com.google.android.gms.dynamic.zzd zzdVarZzdw = zzdw(parcel.readString());
                    parcel2.writeNoException();
