...
public class zzai extends zzd {
    ...
    public final class zza {
        ...
        public Pair<String, Long> zzks() {
            ...
            long j2 = zzai.this.zzMw.getLong(zzkv(), 0L);
            zzkq();
            if (string == null || j2 <= 0) {
                return null;
            }
    ...
    public long zzkk() {
        ...
        zzia();
        if (this.zzMx == 0) {
            long jCurrentTimeMillis = this.zzMw.getLong("first_run", 0L);
            if (jCurrentTimeMillis == 0) {
                jCurrentTimeMillis = zzhP().currentTimeMillis();
                SharedPreferences.Editor editorEdit = this.zzMw.edit();
