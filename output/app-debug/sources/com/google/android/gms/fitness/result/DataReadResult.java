...
public class DataReadResult implements Result, SafeParcelable {
    ...
    public String toString() {
        Object obj;
        Object obj2;
        zzt.zza zzaVarZzg = zzt.zzt(this).zzg("status", this.zzOt);
        if (this.zzajS.size() > 5) {
            obj = this.zzajS.size() + " data sets";
        } else {
            obj = this.zzajS;
        }
        zzt.zza zzaVarZzg2 = zzaVarZzg.zzg("dataSets", obj);
        if (this.zzamP.size() > 5) {
            obj2 = this.zzamP.size() + " buckets";
        } else {
            obj2 = this.zzamP;
        }
        return zzaVarZzg2.zzg("buckets", obj2).toString();
    }
