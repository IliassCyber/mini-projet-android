...
public class SessionInsertRequest implements SafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder addAggregateDataPoint(DataPoint dataPoint) {
            ...
            com.google.android.gms.common.internal.zzu.zzb(startTime > 0 && dataPoint.getEndTime(TimeUnit.NANOSECONDS) > startTime, "Aggregate data point should have valid start and end times: %s", dataPoint);
        ...
        public Builder addDataSet(DataSet dataSet) {
            ...
            com.google.android.gms.common.internal.zzu.zzb(!dataSet.getDataPoints().isEmpty(), "No data points specified in the input data set.");
            this.zzamD.add(dataSource);
    ...
    public IBinder zzqU() {
        zzmu zzmuVar = this.zzalN;
        if (zzmuVar == null) {
            return null;
        }
        return zzmuVar.asBinder();
    }
}
