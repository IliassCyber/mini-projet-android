...
public class SessionReadRequest implements SafeParcelable {
    ...
    public static class Builder {
        ...
        public SessionReadRequest build() {
            ...
            long j = this.zzajH;
            com.google.android.gms.common.internal.zzu.zzb(j > 0 && j > this.zzKT, "Invalid end time: %s", Long.valueOf(this.zzajH));
    ...
    public IBinder zzqU() {
        zzms zzmsVar = this.zzamH;
        if (zzmsVar == null) {
            return null;
        }
        return zzmsVar.asBinder();
    }
