...
public class DataReadRequest implements SafeParcelable {
    ...
    public static class Builder {
        ...
        public DataReadRequest build() {
            ...
            long j = this.zzajH;
            com.google.android.gms.common.internal.zzu.zza(j > 0 && j > this.zzKT, "Invalid end time: %s", Long.valueOf(this.zzajH));
    ...
    public String toString() {
        ...
        if (this.zzajT != 0) {
            sb.append("bucket by ");
            sb.append(Bucket.zzeb(this.zzajT));
            if (this.zzalW > 0) {
                sb.append(" >");
                sb.append(this.zzalW);
                sb.append("ms");
            }
            sb.append(": ");
        }
        ...
        if (this.zzalX != null) {
            ...
            sb.append(this.zzalX.toDebugString());
        }
        if (this.zzama) {
            sb.append(" +server");
        }
    ...
    public IBinder zzqU() {
        zzmf zzmfVar = this.zzamb;
        if (zzmfVar == null) {
            return null;
        }
        return zzmfVar.asBinder();
    }
