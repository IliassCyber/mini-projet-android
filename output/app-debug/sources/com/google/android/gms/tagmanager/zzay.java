...
class zzay extends zzak {
        ...
        switch (zzaVar) {
            ...
            case BACKSLASH:
                ...
                while (it.hasNext()) {
                    ...
                    strReplace = strReplace.replace(string, "\\" + string);
                }
                return strReplace;
            default:
                return str;
    ...
    public zzag.zza zzE(Map<String, zzag.zza> map) {
        ...
        String strZzg = zzaVar2 != null ? zzdf.zzg(zzaVar2) : "";
        zzag.zza zzaVar3 = map.get(zzaLX);
        String strZzg2 = zzaVar3 != null ? zzdf.zzg(zzaVar3) : "=";
        zza zzaVar4 = zza.NONE;
        zzag.zza zzaVar5 = map.get(zzaLY);
        HashSet hashSet = null;
        if (zzaVar5 != null) {
            String strZzg3 = zzdf.zzg(zzaVar5);
        ...
        switch (zzaVar.type) {
            ...
            case 3:
                for (int i2 = 0; i2 < zzaVar.zziT.length; i2++) {
                    ...
                    String strZzg4 = zzdf.zzg(zzaVar.zziT[i2]);
                    String strZzg5 = zzdf.zzg(zzaVar.zziU[i2]);
                    zza(sb, strZzg4, zzaVar4, hashSet);
                    sb.append(strZzg2);
                    zza(sb, strZzg5, zzaVar4, hashSet);
                }
                break;
            default:
