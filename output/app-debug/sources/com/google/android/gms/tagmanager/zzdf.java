        ...
        if (!(obj instanceof String)) {
            if (obj instanceof List) {
                ...
                while (it.hasNext()) {
                    ...
                    zzag.zza zzaVar2 = zzaOB;
                    if (zzaVarZzI == zzaVar2) {
                        return zzaVar2;
                    }
                    z2 = z2 || zzaVarZzI.zzjb;
                ...
                for (Map.Entry entry : setEntrySet) {
                    ...
                    zzag.zza zzaVar3 = zzaOB;
                    if (zzaVarZzI2 == zzaVar3 || zzaVarZzI3 == zzaVar3) {
                        return zzaOB;
                    }
                    z3 = z3 || zzaVarZzI2.zzjb || zzaVarZzI3.zzjb;
