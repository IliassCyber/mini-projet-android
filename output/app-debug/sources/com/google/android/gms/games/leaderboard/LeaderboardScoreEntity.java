...
public final class LeaderboardScoreEntity implements LeaderboardScore {
    ...
    public String getScoreHolderDisplayName() {
        PlayerEntity playerEntity = this.zzatL;
        return playerEntity == null ? this.zzatI : playerEntity.getDisplayName();
    }
    ...
    public Uri getScoreHolderHiResImageUri() {
        PlayerEntity playerEntity = this.zzatL;
        return playerEntity == null ? this.zzatK : playerEntity.getHiResImageUri();
    }

    @Override // com.google.android.gms.games.leaderboard.LeaderboardScore
    public String getScoreHolderHiResImageUrl() {
        PlayerEntity playerEntity = this.zzatL;
        return playerEntity == null ? this.zzatO : playerEntity.getHiResImageUrl();
    }

    @Override // com.google.android.gms.games.leaderboard.LeaderboardScore
    public Uri getScoreHolderIconImageUri() {
        PlayerEntity playerEntity = this.zzatL;
        return playerEntity == null ? this.zzatJ : playerEntity.getIconImageUri();
    }

    @Override // com.google.android.gms.games.leaderboard.LeaderboardScore
    public String getScoreHolderIconImageUrl() {
        PlayerEntity playerEntity = this.zzatL;
        return playerEntity == null ? this.zzatN : playerEntity.getIconImageUrl();
    }
    ...
    @Override // com.google.android.gms.common.data.Freezable
    /* JADX INFO: renamed from: zztG, reason: merged with bridge method [inline-methods] */
