...
public final class GamesClientImpl extends zzi<IGamesService> {
            ...
            try {
                if (questBuffer.getCount() > 0) {
                    ...
                    for (int i = 0; i < size; i++) {
                        if (listZztN.get(i).getMilestoneId().equals(str)) {
    ...
    private static final class LoadRequestsResultImpl implements Requests.LoadRequestsResult {
        ...
        public GameRequestBuffer getRequests(int i) {
            String strZzfG = RequestType.zzfG(i);
    ...
    private static final class RealTimeReliableMessageBinderCallbacks extends AbstractGamesCallbacks {
        ...
        public void zzb(int i, int i2, String str) {
            com.google.android.gms.common.api.zzi<RealTimeMultiplayer.ReliableMessageSentCallback> zziVar = this.zzapV;
            if (zziVar != null) {
                zziVar.zza(new RealTimeMessageSentNotifier(i, i2, str));
            }
        }
    }
    ...
    private static final class RoomBinderCallbacks extends AbstractGamesCallbacks {
        ...
        public void onP2PConnected(String str) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new P2PConnectedNotifier(str));
            }
        }
        ...
        public void onP2PDisconnected(String str) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new P2PDisconnectedNotifier(str));
            }
        }

        @Override // com.google.android.gms.games.internal.AbstractGamesCallbacks, com.google.android.gms.games.internal.IGamesCallbacks
        public void onRealTimeMessageReceived(RealTimeMessage realTimeMessage) {
            com.google.android.gms.common.api.zzi<RealTimeMessageReceivedListener> zziVar = this.zzaqd;
            if (zziVar != null) {
                zziVar.zza(new MessageReceivedNotifier(realTimeMessage));
            }
        }
        ...
        public void zzA(DataHolder dataHolder) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new RoomAutoMatchingNotifier(dataHolder));
            }
        }
        ...
        public void zzC(DataHolder dataHolder) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new ConnectedToRoomNotifier(dataHolder));
            }
        }
        ...
        public void zzD(DataHolder dataHolder) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new DisconnectedFromRoomNotifier(dataHolder));
            }
        }
        ...
        public void zza(DataHolder dataHolder, String[] strArr) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new PeerInvitedToRoomNotifier(dataHolder, strArr));
            }
        }
        ...
        public void zzb(DataHolder dataHolder, String[] strArr) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new PeerJoinedRoomNotifier(dataHolder, strArr));
            }
        }
        ...
        public void zzc(DataHolder dataHolder, String[] strArr) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new PeerLeftRoomNotifier(dataHolder, strArr));
            }
        }
        ...
        public void zzd(DataHolder dataHolder, String[] strArr) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new PeerDeclinedNotifier(dataHolder, strArr));
            }
        }
        ...
        public void zze(DataHolder dataHolder, String[] strArr) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new PeerConnectedNotifier(dataHolder, strArr));
            }
        }
        ...
        public void zzf(DataHolder dataHolder, String[] strArr) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new PeerDisconnectedNotifier(dataHolder, strArr));
            }
        }
        ...
        public void zzz(DataHolder dataHolder) {
            com.google.android.gms.common.api.zzi<? extends RoomStatusUpdateListener> zziVar = this.zzaqc;
            if (zziVar != null) {
                zziVar.zza(new RoomConnectingNotifier(dataHolder));
            }
        }
    }
    ...
    */
    public void zza(com.google.android.gms.common.api.zza.zzb<com.google.android.gms.games.Players.LoadPlayersResult> r9, java.lang.String r10, java.lang.String r11, int r12, boolean r13, boolean r14) throws android.os.RemoteException {
        /*
            r8 = this;
            int r0 = r10.hashCode()
        ...
        L36:
            ...
            throw r9
        L4d:
            android.os.IInterface r0 = r8.zznM()
            r1 = r0
            com.google.android.gms.games.internal.IGamesService r1 = (com.google.android.gms.games.internal.IGamesService) r1
            com.google.android.gms.games.internal.GamesClientImpl$PlayersLoadedBinderCallback r2 = new com.google.android.gms.games.internal.GamesClientImpl$PlayersLoadedBinderCallback
            r2.<init>(r9)
            r3 = r10
            r4 = r11
            r5 = r12
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.games.internal.GamesClientImpl.zza(com.google.android.gms.common.api.zza$zzb, java.lang.String, java.lang.String, int, boolean, boolean):void");
    }
    ...
    public String zzsw() {
        PlayerEntity playerEntity = this.zzaoS;
