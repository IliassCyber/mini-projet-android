...
public class OpenFileActivityBuilder {
    ...
    public IntentSender build(GoogleApiClient googleApiClient) {
        ...
        Filter filter = this.zzadx;
        try {
            return ((zzs) googleApiClient.zza(Drive.zzNX)).zzpB().zza(new OpenFileIntentSenderRequest(this.zzadv, this.zzadw, this.zzady, filter == null ? null : new FilterHolder(filter)));
