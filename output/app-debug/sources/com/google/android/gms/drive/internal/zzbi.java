...
class zzbi extends zzd {
    ...
    public void zza(OnDownloadProgressResponse onDownloadProgressResponse) throws RemoteException {
        DriveFile.DownloadProgressListener downloadProgressListener = this.zzags;
        if (downloadProgressListener != null) {
            downloadProgressListener.onProgress(onDownloadProgressResponse.zzpM(), onDownloadProgressResponse.zzpN());
        }
    }
