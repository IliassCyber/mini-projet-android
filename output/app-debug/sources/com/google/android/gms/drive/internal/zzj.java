...
public class zzj {
    ...
    public IntentSender build(GoogleApiClient googleApiClient) {
        ...
        Integer num = this.zzaey;
        try {
            return zzsVar.zzpB().zza(new CreateFileIntentSenderRequest(this.zzaex.zzpm(), num == null ? 0 : num.intValue(), this.zzadv, this.zzady, this.zzaez));
