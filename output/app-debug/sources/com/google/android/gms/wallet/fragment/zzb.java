...
public class zzb implements Parcelable.Creator<WalletFragmentOptions> {
    ...
    public WalletFragmentOptions createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == iZzab) {
            return new WalletFragmentOptions(iZzg, iZzg2, iZzg3, walletFragmentStyle, iZzg4);
        }
        throw new zza.C0036zza("Overread allowed size end=" + iZzab, parcel);
    }

    @Override // android.os.Parcelable.Creator
    /* JADX INFO: renamed from: zzjz, reason: merged with bridge method [inline-methods] */
