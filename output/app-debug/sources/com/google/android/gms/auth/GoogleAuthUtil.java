...
public final class GoogleAuthUtil {
    ...
    public static void clearToken(Context context, String str) throws GoogleAuthException, IOException {
        ...
        try {
            ...
            try {
                Bundle bundleZza = zzau.zza.zza(zzaVar.zzmh()).zza(str, bundle);
    ...
    public static Bundle zza(Context context, Account account, String str, Bundle bundle) throws GoogleAuthException, IOException {
        Context applicationContext = context.getApplicationContext();
        zzu.zzbZ("Calling this from your main thread can lead to deadlock");
        zzY(applicationContext);
