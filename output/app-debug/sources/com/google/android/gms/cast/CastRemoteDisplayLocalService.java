...
public abstract class CastRemoteDisplayLocalService extends Service {
    ...
    public static void startService(final Context context, Class<? extends CastRemoteDisplayLocalService> cls, final String str, final CastDevice castDevice, final NotificationSettings notificationSettings, final Callbacks callbacks) {
        ...
        context.bindService(intent, new ServiceConnection() { // from class: com.google.android.gms.cast.CastRemoteDisplayLocalService.2
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                CastRemoteDisplayLocalService castRemoteDisplayLocalServiceZzlp = ((zza) iBinder).zzlp();
                if (castRemoteDisplayLocalServiceZzlp != null) {
                    castRemoteDisplayLocalServiceZzlp.zza(str, castDevice, notificationSettings, context, this, callbacks);
                    return;
                }
    ...
    public static void zzM(boolean z) {
        ...
        synchronized (zzQY) {
            ...
            if (!z && castRemoteDisplayLocalService.zzRl != null) {
                ...
                MediaRouter mediaRouter = castRemoteDisplayLocalService.zzRl;
            ...
            Context context = castRemoteDisplayLocalService.zzRj;
            if (context != null && (serviceConnection = castRemoteDisplayLocalService.zzRk) != null) {
    ...
    private Notification zzN(boolean z) {
        ...
        if (TextUtils.isEmpty(string2)) {
            string2 = getString(i, new Object[]{this.zzRh.getFriendlyName()});
        }
        Notification notificationBuild = new NotificationCompat.Builder(this).setContentTitle(string).setContentText(string2).setContentIntent(this.zzRe.zzRv).setSmallIcon(i2).setOngoing(true).addAction(android.R.drawable.ic_menu_close_clear_cancel, getString(com.google.android.gms.R.string.cast_notification_disconnect), zzlm()).build();
    ...
    public void zza(String str, CastDevice castDevice, NotificationSettings notificationSettings, Context context, ServiceConnection serviceConnection, Callbacks callbacks) {
        ...
        if (this.zzRe.mNotification == null) {
            this.zzRf = true;
            notificationZzN = zzN(false);
        } else {
            this.zzRf = false;
            notificationZzN = this.zzRe.mNotification;
        }
        this.mNotification = notificationZzN;
    ...
    public void zzlh() {
        ...
        GoogleApiClient googleApiClient = this.zzRa;
