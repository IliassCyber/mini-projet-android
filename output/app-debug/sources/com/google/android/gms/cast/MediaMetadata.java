...
public class MediaMetadata {
                    ...
                    if (strZzbx == null) {
                        ...
                        try {
                            ...
                            if (obj2 != null) {
                                ...
                                bundle.putString(strZzbx, (String) obj2);
                            }
                        } catch (JSONException e) {
                        }
                    }
    ...
    public int hashCode() {
        ...
        int iHashCode = 17;
        while (it.hasNext()) {
            iHashCode = (iHashCode * 31) + this.zzRN.get(it.next()).hashCode();
        }
        return (iHashCode * 31) + this.zzvi.hashCode();
    }
    ...
    public JSONObject toJson() {
        ...
        switch (this.zzRO) {
            case 0:
                strArr = new String[]{KEY_TITLE, KEY_ARTIST, KEY_SUBTITLE, KEY_RELEASE_DATE};
                break;
            case 1:
                strArr = new String[]{KEY_TITLE, KEY_STUDIO, KEY_SUBTITLE, KEY_RELEASE_DATE};
                break;
            case 2:
                strArr = new String[]{KEY_TITLE, KEY_SERIES_TITLE, KEY_SEASON_NUMBER, KEY_EPISODE_NUMBER, KEY_BROADCAST_DATE};
                break;
            case 3:
                strArr = new String[]{KEY_TITLE, KEY_ARTIST, KEY_ALBUM_TITLE, KEY_ALBUM_ARTIST, KEY_COMPOSER, KEY_TRACK_NUMBER, KEY_DISC_NUMBER, KEY_RELEASE_DATE};
                break;
            case 4:
