...
public class RemoteMediaPlayer implements Cast.MessageReceivedCallback {
        ...
        zzb(GoogleApiClient googleApiClient) {
            ...
            this.zzTa = new zzo() { // from class: com.google.android.gms.cast.RemoteMediaPlayer.zzb.1
                ...
                public void zzy(long j) {
                    zzb zzbVar = zzb.this;
                    zzbVar.setResult(zzbVar.createFailedResult(new Status(2103)));
                }
            };
        }
    ...
    public void onMetadataUpdated() {
        OnMetadataUpdatedListener onMetadataUpdatedListener = this.zzSx;
    ...
    public void onPreloadStatusUpdated() {
        OnPreloadStatusUpdatedListener onPreloadStatusUpdatedListener = this.zzSv;
    ...
    public void onQueueStatusUpdated() {
        OnQueueStatusUpdatedListener onQueueStatusUpdatedListener = this.zzSw;
    ...
    public void onStatusUpdated() {
        OnStatusUpdatedListener onStatusUpdatedListener = this.zzSy;
    ...
    public PendingResult<MediaChannelResult> queueMoveItemToNewIndex(final GoogleApiClient googleApiClient, final int i, final int i2, final JSONObject jSONObject) {
        return googleApiClient.zzb(new zzb(googleApiClient) { // from class: com.google.android.gms.cast.RemoteMediaPlayer.15
            ...
            public void zza(zze zzeVar) {
                zza zzaVar;
                synchronized (RemoteMediaPlayer.this.zzqt) {
                    int iZzaH = RemoteMediaPlayer.this.zzaH(i);
                    if (iZzaH == -1) {
                        setResult(createFailedResult(new Status(0)));
                        return;
                    }
                    ...
                    MediaQueueItem queueItem = RemoteMediaPlayer.this.getMediaStatus().getQueueItem(i2 > iZzaH ? i2 + 1 : i2);
