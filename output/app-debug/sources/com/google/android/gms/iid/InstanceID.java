...
public class InstanceID {
    ...
    static String zza(KeyPair keyPair) {
        try {
            ...
            bArrDigest[0] = (byte) (((bArrDigest[0] & 15) + 112) & MotionEventCompat.ACTION_MASK);
    ...
    public String getToken(String str, String str2, Bundle bundle) throws IOException {
        ...
        String strZzg = zzui() ? null : zzawO.zzg(this.zzawR, str, str2);
        if (strZzg != null) {
            return strZzg;
        }
        if (bundle == null) {
        ...
        if (strZzc != null) {
            zzawO.zza(this.zzawR, str, str2, strZzc, zzawT);
        }
        return strZzc;
    }
