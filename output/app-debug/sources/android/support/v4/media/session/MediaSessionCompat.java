    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public void setMetadata(MediaMetadataCompat metadata) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                boolean canRate = (playbackStateCompat == null || (playbackStateCompat.getActions() & 128) == 0) ? false : true;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public PlaybackStateCompat getStateWithUpdatedPosition() throws Throwable {
            long position;
            long duration = -1;
            synchronized (this.mLock) {
                try {
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public android.support.v4.media.session.ParcelableVolumeInfo getVolumeAttributes() {
                /*
                    ...
                    java.lang.Object r0 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.access$1300(r0)
                    monitor-enter(r0)
                    r1 = 0
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplBase r2 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.this     // Catch: java.lang.Throwable -> L64
                    int r2 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.access$300(r2)     // Catch: java.lang.Throwable -> L64
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplBase r3 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.this     // Catch: java.lang.Throwable -> L5e
                    int r3 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.access$400(r3)     // Catch: java.lang.Throwable -> L5e
                    r9 = r3
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplBase r3 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.this     // Catch: java.lang.Throwable -> L5a
                    android.support.v4.media.VolumeProviderCompat r3 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.access$200(r3)     // Catch: java.lang.Throwable -> L5a
                    r4 = 2
                    if (r2 != r4) goto L2e
                    int r4 = r3.getVolumeControl()     // Catch: java.lang.Throwable -> L5a
                    int r5 = r3.getMaxVolume()     // Catch: java.lang.Throwable -> L58
                    int r1 = r3.getCurrentVolume()     // Catch: java.lang.Throwable -> L6d
                    r11 = r1
                    r1 = r4
                    r10 = r5
                    goto L46
                L2e:
                    r4 = 2
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplBase r5 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.this     // Catch: java.lang.Throwable -> L58
                    android.media.AudioManager r5 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.access$1500(r5)     // Catch: java.lang.Throwable -> L58
                    int r5 = r5.getStreamMaxVolume(r9)     // Catch: java.lang.Throwable -> L58
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplBase r6 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.this     // Catch: java.lang.Throwable -> L6d
                    android.media.AudioManager r6 = android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.access$1500(r6)     // Catch: java.lang.Throwable -> L6d
                    int r1 = r6.getStreamVolume(r9)     // Catch: java.lang.Throwable -> L6d
                    r11 = r1
                    r1 = r4
                    r10 = r5
                L46:
