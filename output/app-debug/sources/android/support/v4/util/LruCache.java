...
public class LruCache<K, V> {
    ...
    public final V get(K k) throws Throwable {
        V vPut;
        if (k == null) {
    ...
    public final V put(K key, V value) throws Throwable {
        V previous;
     ...
     */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:30:? -> B:26:0x0076). Please report as a decompilation issue!!! */
    /*
    ...
    */
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public final V remove(K key) throws Throwable {
        Throwable th;
        if (key == null) {
            throw new NullPointerException("key == null");
        }
