        ...
        if (action != 6) {
            switch (action) {
                ...
                case 2:
                    ...
                    if (yDiff > i2 && !this.mIsBeingDragged) {
            ...
            switch (action) {
                ...
                case 3:
                    ...
                    if (i == -1) {
                        ...
                        float y = MotionEventCompat.getY(ev, MotionEventCompat.findPointerIndex(ev, i));
                    ...
                    if (pointerIndex < 0) {
                        ...
                        if (!this.mIsBeingDragged) {
                            ...
                            if (originalDragPercent >= 0.0f) {
                                ...
                                double dPow = Math.pow(tensionSlingshotPercent / 4.0f, 2.0d);
                                Double.isNaN(d2);
                                float tensionPercent = ((float) (d2 - dPow)) * DECELERATE_INTERPOLATION_FACTOR;
                                ...
                                if (overscrollTop2 >= f) {
                                    ...
                                    if (this.mScale) {
                                        setAnimationProgress(overscrollTop2 / f);
                                    }
                                ...
                                float rotation = (((0.4f * adjustedPercent) - 0.25f) + (tensionPercent * DECELERATE_INTERPOLATION_FACTOR)) * DRAG_RATE;
