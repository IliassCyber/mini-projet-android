...
public class SlidingPaneLayout extends ViewGroup {
    ...
    /* JADX WARN: Removed duplicated region for block: B:39:0x00be A[PHI: r9
  0x00be: PHI (r9v4 'weightSum' float) = (r9v3 'weightSum' float), (r9v11 'weightSum' float) binds: [B:35:0x00b1, B:37:0x00b8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            ...
            boolean result2 = child.isDrawingCacheEnabled();
            if (result2) {
