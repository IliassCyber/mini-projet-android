...
public class ViewDragHelper {
    ...
    private float distanceInfluenceForSnapDuration(float f) {
        double d = f - 0.5f;
        Double.isNaN(d);
        float f2 = (float) (d * 0.4712389167638204d);
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        int pointerCount;
        View toCapture;
        int action2 = MotionEventCompat.getActionMasked(ev);
        ...
        switch (action2) {
            ...
            case 2:
                ...
                while (i2 < pointerCount2) {
                    int pointerId2 = MotionEventCompat.getPointerId(ev, i2);
                    float x2 = MotionEventCompat.getX(ev, i2);
                    float y2 = MotionEventCompat.getY(ev, i2);
                ...
                break;
            case 5:
                int pointerId3 = MotionEventCompat.getPointerId(ev, actionIndex2);
                float x3 = MotionEventCompat.getX(ev, actionIndex2);
                float y3 = MotionEventCompat.getY(ev, actionIndex2);
                ...
                } else if (i3 == 2 && (toCapture = findTopChildUnder((int) x3, (int) y3)) == this.mCapturedView) {
                    tryCaptureViewForDrag(toCapture, pointerId3);
                }
                break;
            case 6:
                clearMotionHistory(MotionEventCompat.getPointerId(ev, actionIndex2));
                break;
        }
        ...
        switch (action) {
            ...
            case 6:
                ...
                if (this.mDragState == 1 && pointerId4 == this.mActivePointerId) {
                    ...
                    while (true) {
                        if (i5 < pointerCount2) {
                            int id = MotionEventCompat.getPointerId(ev, i5);
                            if (id != this.mActivePointerId) {
                                View viewFindTopChildUnder = findTopChildUnder((int) MotionEventCompat.getX(ev, i5), (int) MotionEventCompat.getY(ev, i5));
