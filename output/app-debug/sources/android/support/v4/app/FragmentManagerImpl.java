...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory {
    ...
    private void throwException(RuntimeException ex) {
        ...
        if (fragmentActivity != null) {
            try {
                fragmentActivity.dump("  ", null, pw, new String[0]);
                throw ex;
            } catch (Exception e) {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (arrayList != null && (N6 = arrayList.size()) > 0) {
            writer.print(prefix);
        ...
        if (arrayList2 != null && (N5 = arrayList2.size()) > 0) {
            writer.print(prefix);
        ...
        if (arrayList3 != null && (N4 = arrayList3.size()) > 0) {
            writer.print(prefix);
        ...
        if (arrayList4 != null && (N3 = arrayList4.size()) > 0) {
            writer.print(prefix);
    ...
    /* JADX WARN: Removed duplicated region for block: B:192:0x03a9 A[FALL_THROUGH, PHI: r13
  0x03a9: PHI (r13v3 'newState' int) = 
  (r13v1 'newState' int)
  (r13v1 'newState' int)
  (r13v1 'newState' int)
  (r13v1 'newState' int)
  ...
  (r13v4 'newState' int)
  (r13v4 'newState' int)
 binds: [B:122:0x0261, B:124:0x0265, B:168:0x0337, B:185:0x037a, B:189:0x0384, B:188:0x0380, B:176:0x034c, B:34:0x005b, B:113:0x021b, B:117:0x0237] A[DONT_GENERATE, DONT_INLINE]] */
    /*
    ...
    */
    ...
    void makeActive(Fragment f) {
        ...
        if (arrayList == null || arrayList.size() <= 0) {
            ...
            f.setIndex(this.mAvailIndices.remove(r0.size() - 1).intValue(), this.mParent);
    ...
    */
    public boolean execPendingActions() {
        ...
        L16:
            monitor-enter(r6)
            java.util.ArrayList<java.lang.Runnable> r3 = r6.mPendingActions     // Catch: java.lang.Throwable -> L95
            if (r3 == 0) goto L66
            java.util.ArrayList<java.lang.Runnable> r3 = r6.mPendingActions     // Catch: java.lang.Throwable -> L95
        ...
        L24:
            java.util.ArrayList<java.lang.Runnable> r3 = r6.mPendingActions     // Catch: java.lang.Throwable -> L95
            int r0 = r3.size()     // Catch: java.lang.Throwable -> L95
            java.lang.Runnable[] r3 = r6.mTmpActions     // Catch: java.lang.Throwable -> L95
            if (r3 == 0) goto L33
            java.lang.Runnable[] r3 = r6.mTmpActions     // Catch: java.lang.Throwable -> L95
            int r3 = r3.length     // Catch: java.lang.Throwable -> L95
            if (r3 >= r0) goto L37
        L33:
            java.lang.Runnable[] r3 = new java.lang.Runnable[r0]     // Catch: java.lang.Throwable -> L95
            r6.mTmpActions = r3     // Catch: java.lang.Throwable -> L95
        L37:
            java.util.ArrayList<java.lang.Runnable> r3 = r6.mPendingActions     // Catch: java.lang.Throwable -> L95
            java.lang.Runnable[] r4 = r6.mTmpActions     // Catch: java.lang.Throwable -> L95
            r3.toArray(r4)     // Catch: java.lang.Throwable -> L95
            java.util.ArrayList<java.lang.Runnable> r3 = r6.mPendingActions     // Catch: java.lang.Throwable -> L95
            r3.clear()     // Catch: java.lang.Throwable -> L95
            android.support.v4.app.FragmentActivity r3 = r6.mActivity     // Catch: java.lang.Throwable -> L95
            android.os.Handler r3 = r3.mHandler     // Catch: java.lang.Throwable -> L95
            java.lang.Runnable r4 = r6.mExecCommit     // Catch: java.lang.Throwable -> L95
