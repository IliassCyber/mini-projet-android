...
public class GestureDetectorCompat {
    ...
    static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        public boolean onTouchEvent(MotionEvent ev) {
            ...
            boolean pointerUp2 = (action & MotionEventCompat.ACTION_MASK) == 6;
            ...
            switch (action & MotionEventCompat.ACTION_MASK) {
                ...
                case 2:
                    ...
                    if (deltaY2 > this.mTouchSlopSquare) {
                ...
                case 6:
                    ...
                    int id1 = MotionEventCompat.getPointerId(ev, upIndex2);
                    ...
                    while (action2 < count) {
                        if (action2 == upIndex2) {
                            ...
                            pointerUp = pointerUp2;
                            int id2 = MotionEventCompat.getPointerId(ev, action2);
                            skipIndex = skipIndex2;
                            float x = VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, id2) * x1;
                            upIndex = upIndex2;
                            float y = VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, id2) * y1;
                            float dot = x + y;
                            if (dot < 0.0f) {
