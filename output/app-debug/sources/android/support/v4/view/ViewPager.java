        ...
        if (getWindowToken() != null) {
            ...
            if (N != this.mExpectedAdapterCount) {
                try {
                    ...
                    String resName2 = Integer.toHexString(getId());
                    resName = resName2;
                }
            ...
            if (curItem != null) {
                ...
                if (clientWidth <= 0) {
                    ...
                    curIndex = curIndex2;
                    paddingLeft = (getPaddingLeft() / clientWidth) + (2.0f - curItem.widthFactor);
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            while (pos < lastPos) {
                ...
                int i = this.mPageMargin;
                if (i + widthFactor > scrollX) {
                    marginOffset = marginOffset2;
                    this.mMarginDrawable.setBounds((int) widthFactor, this.mTopPageBounds, (int) (i + widthFactor + 0.5f), this.mBottomPageBounds);
