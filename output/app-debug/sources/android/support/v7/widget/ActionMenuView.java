...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int cellSizeRemaining2 = widthSize2 % i2;
        if (cellCount == 0) {
            setMeasuredDimension(widthSize2, 0);
            return;
        }
        int cellSize = i2 + (cellSizeRemaining2 / cellCount);
                ...
                if (i4 < childCount3) {
                    ...
                    if ((minCellsAt & ((long) minCellsItemCount3)) == 0) {
                        ...
                        if (centerSingleExpandedItem && lp3.preventEdgeOffset && maxCellsUsed == 1) {
                            ...
                            child2.setPadding(i5 + cellSize, 0, i5, 0);
                        }
                        lp3.cellsUsed++;
                        lp3.expanded = true;
                        maxCellsUsed--;
        ...
        if (maxCellsUsed > 0 && smallestItemsAt != 0 && (maxCellsUsed < maxChildHeight2 - 1 || singleItem || expandableItemCount > 1)) {
            ...
            if (expandCount > 0.0f) {
                i = (int) ((maxCellsUsed * cellSize) / expandCount);
            }
            int extraPixels = i;
