...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int layoutResId = a.getResourceId(R.styleable.SearchView_layout, 0);
    ...
    private CharSequence getDecoratedHint(CharSequence hintText) {
        ...
        searchIcon.setBounds(0, 0, textSize2, textSize2);
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        ...
        try {
            ...
            if (IS_AT_LEAST_FROYO && data2 == null) {
    ...
    private static class AutoCompleteTextViewReflector {
        ...
        void showSoftInputUnchecked(InputMethodManager imm, View view, int flags) {
            ...
            if (method != null) {
                try {
                    method.invoke(imm, Integer.valueOf(flags), null);
                    return;
                } catch (Exception e) {
                }
            }
