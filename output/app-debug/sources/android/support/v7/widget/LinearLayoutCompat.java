...
public class LinearLayoutCompat extends ViewGroup {
    ...
    @IntDef(flag = true, value = {Connections.DURATION_INDEFINITE, 1, 2, 4})
    ...
    */
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        if (majorGravity == 16) {
            ...
            childTop = ((childTop2 + bottom) - top) - this.mTotalLength;
        } else {
        ...
        while (i2 < count) {
            ...
            if (child == null) {
                ...
                if (layoutDirection == 1) {
                    int childLeft2 = ((((childSpace - childWidth) / 2) + paddingLeft2) + lp.leftMargin) - lp.rightMargin;
