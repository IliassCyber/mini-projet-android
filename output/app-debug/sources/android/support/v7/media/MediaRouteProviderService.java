...
public abstract class MediaRouteProviderService extends Service {
    ...
    public boolean updateCompositeDiscoveryRequest() {
        ...
        MediaRouteDiscoveryRequest mediaRouteDiscoveryRequest = this.mCompositeDiscoveryRequest;
        if (mediaRouteDiscoveryRequest == composite) {
            return false;
        }
        if (mediaRouteDiscoveryRequest == null || !mediaRouteDiscoveryRequest.equals(composite)) {
    ...
    private final class ClientRecord implements IBinder.DeathRecipient {
        ...
        public boolean setDiscoveryRequest(MediaRouteDiscoveryRequest request) {
            ...
            if (mediaRouteDiscoveryRequest == request) {
                return false;
            }
            if (mediaRouteDiscoveryRequest == null || !mediaRouteDiscoveryRequest.equals(request)) {
