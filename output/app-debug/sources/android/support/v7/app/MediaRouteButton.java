...
public class MediaRouteButton extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Drawable drawable = this.mRemoteIndicator;
        int minWidth = Math.max(i, drawable != null ? drawable.getIntrinsicWidth() : 0);
        int i2 = this.mMinHeight;
        Drawable drawable2 = this.mRemoteIndicator;
        int minHeight = Math.max(i2, drawable2 != null ? drawable2.getIntrinsicHeight() : 0);
        ...
        if (heightMode != Integer.MIN_VALUE) {
            ...
            height = Math.min(heightSize, height2 + minHeight + getPaddingBottom());
        }
