...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent {
    ...
    protected boolean fitSystemWindows(Rect insets) {
        ...
        if (actionBarContainer != null) {
            changed |= applyInsets(actionBarContainer, insets, true, false, true, true);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(maxWidth2 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), widthMeasureSpec, childState2), ViewCompat.resolveSizeAndState(Math.max(maxHeight4 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), heightMeasureSpec, childState2 << 16));
    }
