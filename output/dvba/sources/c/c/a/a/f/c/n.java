...
public abstract class n<E> extends l<E> implements List<E>, RandomAccess {
    ...
    public static final z<Object> f1465c = new m(t.f, 0);

    public static <E> n<E> g(E e, E e2, E e3, E e4, E e5, E e6, E e7, E e8) {
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i = 0; i < size; i++) {
                        if (c.c.a.a.c.l.q.y0(get(i), list.get(i))) {
                        }
                    }
                    return true;
                }
    ...
    public n<E> subList(int i, int i2) {
        c.c.a.a.c.l.q.u0(i, i2, size());
        int i3 = i2 - i;
        return i3 == size() ? this : i3 == 0 ? (n<E>) t.f : new p(this, i, i3);
    }
    ...
    public /* synthetic */ ListIterator listIterator(int i) {
        ...
        return isEmpty() ? f1465c : new m(this, i);
    }
