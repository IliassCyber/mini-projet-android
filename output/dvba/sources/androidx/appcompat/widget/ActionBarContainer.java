...
public class ActionBarContainer extends FrameLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        return this.f57b || super.onInterceptTouchEvent(motionEvent);
    }
    ...
    public void setStackedBackground(Drawable drawable) {
        ...
        if (drawable != null) {
            ...
            if (this.j && (drawable2 = this.g) != null) {
                drawable2.setBounds(this.f58c.getLeft(), this.f58c.getTop(), this.f58c.getRight(), this.f58c.getBottom());
            }
        }
        boolean z = true;
        if (!this.i ? this.f != null || this.g != null : this.h != null) {
