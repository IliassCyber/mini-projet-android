    ...
    */
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            iR = r(view2);
            measuredHeight = view2.getMeasuredHeight() - iR;
            paddingBottom += iR;
        ...
        if (view2 != null) {
            int i5 = paddingBottom - iR;
            int iMin = Math.min(i4, measuredHeight);
            if (iMin > 0) {
                i4 -= iMin;
                iR += iMin;
            }
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iR, 1073741824));
