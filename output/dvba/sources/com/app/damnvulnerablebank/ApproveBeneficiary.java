...
public class ApproveBeneficiary extends h {
    public TextView p;
    ...
    public class a implements q.b<JSONObject> {
        ...
        public void a(JSONObject jSONObject) {
            ...
            try {
                Toast.makeText(ApproveBeneficiary.this.getApplicationContext(), "" + e.a(jSONObject2.get("enc_data").toString()), 0).show();
    ...
    public class c extends g {
        ...
        public c(ApproveBeneficiary approveBeneficiary, int i, String str, JSONObject jSONObject, q.b bVar, q.a aVar, String str2) {
    ...
    public void approveBeneficiary(View view) {
        ...
        pVarZ.a(new c(this, 1, c.a.a.a.a.c(getSharedPreferences("apiurl", 0).getString("apiurl", null), "/api/beneficiary/approve"), jSONObject2, new a(), new b(), string));
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.p.setText(getIntent().getStringExtra("id"));
    }
}
