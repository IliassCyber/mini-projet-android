...
public class o extends c implements Menu {
    public final b.i.h.a.a d;

    public o(Context context, b.i.h.a.a aVar) {
        super(context);
        if (aVar == null) {
    ...
    @Override // android.view.Menu
    public void clear() {
        b.f.h<b.i.h.a.b, MenuItem> hVar = this.f349b;
        if (hVar != null) {
            hVar.clear();
        }
        b.f.h<b.i.h.a.c, SubMenu> hVar2 = this.f350c;
        if (hVar2 != null) {
            hVar2.clear();
        }
        this.d.clear();
