...
public final class p {
    ...
    public static Method f845a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f845a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    public static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f845a) != null) {
            try {
