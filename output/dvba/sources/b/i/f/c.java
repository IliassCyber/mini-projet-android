...
public class c {
    ...
    public c(c cVar) {
        ...
        float[] fArr = cVar.f747b;
        this.f747b = a.a.a.a.a.o(fArr, 0, fArr.length);
    }
    ...
    public static void a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        ...
        double d34 = dAtan22 / ((double) iCeil);
        double d35 = dAtan2;
        while (i < iCeil) {
            double d36 = d35 + d34;
    ...
    public static void b(c[] cVarArr, Path path) {
        ...
        while (i4 < cVarArr2.length) {
            char c6 = cVarArr2[i4].f746a;
            float[] fArr3 = cVarArr2[i4].f747b;
            float f20 = fArr2[c4];
            float f21 = fArr2[1];
            float f22 = fArr2[2];
            float f23 = fArr2[3];
